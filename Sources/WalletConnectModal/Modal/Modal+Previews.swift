    ...
    struct Content: View {
        ...
        init() {
            ...
            let metadata = AppMetadata(
                ...
                redirect: try! AppMetadata.Redirect(native: "showcase://", universal: nil)
            )
            
            Networking.configure(groupIdentifier: "group.crush", projectId: projectId, socketFactory: WebSocketFactoryMock())
